...
const KEEP_TIME = 'videoplayer-current-time';
...
function onCurrentTime(evt) {
  localStorage.setItem(KEEP_TIME, evt.seconds);
}

function getCurrentTime() {
  if (localStorage.getItem(KEEP_TIME)) {
    player.setCurrentTime(localStorage.getItem(KEEP_TIME));
  }
}
